...
output = map_dfr(df, mean_and_sd) # join the output list elements
...
output = map_dfr(vec_urls, read_page_reviews)
```
...
```
    ...
    ## file path:          C:\Users\Kasza Lab\AppData\Local\rnoaa\rnoaa\Cache/ghcnd/USC00519397.dly

    ## file last updated:  2019-11-08 18:02:57

    ## file min/max dates: 1965-01-01 / 2019-10-31

    ## file path:          C:\Users\Kasza Lab\AppData\Local\rnoaa\rnoaa\Cache/ghcnd/USS0023B17S.dly

    ## file last updated:  2019-11-08 18:03:03

    ## file min/max dates: 1999-09-01 / 2019-11-30
